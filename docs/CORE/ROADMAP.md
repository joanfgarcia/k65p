...
| 2.2 | **Verification loop**: expression → validator (form) → bridge → Prolog (consequence) → verdict. CLI: `python main.py verify "<expr>"` | `k65p` |
...
3. **System 1/2 integration**: Bit proposes, Prolog disposes; incremental KB growth from
